...
export class User extends Entity {
  ...
  get objects(): ObjectLoader {
    return new ObjectLoader("User", this.get("id")!.toString(), "objects");
  }
}
...
export class Object extends Entity {
  ...
  save(): void {
    ...
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        `Entities of type Object must have an ID of type String but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("Object", id.toString(), this);
    }
  }

  static loadInBlock(id: string): Object | null {
    return changetype<Object | null>(store.get_in_block("Object", id));
  }

  static load(id: string): Object | null {
    return changetype<Object | null>(store.get("Object", id));
  }
...
export class ObjectLoader extends Entity {
  _entity: string;
  _field: string;
  _id: string;
